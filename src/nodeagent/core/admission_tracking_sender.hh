 ...
 */
class AdmissionTrackingSender final : public nodeagent::ResultSender {
public:
  AdmissionTrackingSender(nodeagent::ResultSenderPtr inner, AdmissionScopePtr scope)
...
private:
  nodeagent::ResultSenderPtr inner_;
